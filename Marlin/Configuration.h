...
#define CUSTOM_MACHINE_NAME "My Ass Is"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 459.32 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS              35 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
